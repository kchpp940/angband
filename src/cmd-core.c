...
static const struct command_info game_cmds[] =
{
	...
	{ CMD_EQUIP_SET_SAVE, "save equipment set", do_cmd_equip_set_save, false, false, 0 },
	{ CMD_EQUIP_SET_LOAD, "load equipment set", do_cmd_equip_set_load, false, true, 0 },
	{ CMD_EQUIP_SET_DELETE, "delete equipment set", do_cmd_equip_set_delete, false, false, 0 },
	{ CMD_EQUIP_SET_LIST, "list equipment sets", do_cmd_equip_set_list, false, false, 0 },
