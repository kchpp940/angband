...
/**
 * Include build capabilities (ANGBAND_CAP_* macros) and backward-compat
 * legacy defines (USE_*, ALLOW_BORG, etc.).  Generated by the build system
 * (CMake or Autotools); falls back to the in-tree defaults for manual builds.
 */
