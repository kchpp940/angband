...
/**
 * Unified build capability header.
 *
 * Generated by both CMake and Autotools in the build directory from
 * src/build-capabilities.h.in.  Declares all ANGBAND_CAP_* macros and
 * provides backward-compatible USE_* / SOUND / ALLOW_BORG mappings.
 *
 * The build directory is always on the include path, so this header
 * must always be found when building through either supported system.
 */
